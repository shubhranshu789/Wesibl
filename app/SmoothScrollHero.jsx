...
export default function SmoothScrollHero2() {
...
`;
  ...
  return (
    <motion.section
      style={{ height: `calc(${SECTION_HEIGHT}px + 100vh)`, backgroundImage }}
      className="relative w-full absolute top-0 left-0 right-0 h-96 bg-gradient-to-b from-zinc-950/0 to-zinc-950"
    >
      {/* Canvas background at lowest z */}
